...
ARTS = [
    ...
    "09_outputs/prospective/P7_TARGET_GENE_CLAIM_v1.md",
    "09_outputs/prospective/P7_target_gene_ranking_v1.md",
    "09_outputs/prospective/P7_target_gene_ranking_v1.json",
    "09_outputs/prospective/P4_INDEPENDENT_MODEL_CLAIM_v1.md",
    "09_outputs/prospective/P4_independent_model_matrix_v1.md",
    "09_outputs/prospective/P4_independent_model_matrix_v1.json",
    "09_outputs/prospective/P4_G2b_independence_notes_v1.md",
    ...
    "pilot_scaffold/scripts/run_p7_target_gene_ranking.py",
    "pilot_scaffold/scripts/run_p4_independent_model_matrix.py",
